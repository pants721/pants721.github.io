...
```sh
curl https://nukem.dev/lucasnewcomb.age | age -R - message.txt > message.txt.age
```

### pgp

```sh
curl https://nukem.dev/lucasnewcomb.pgp.asc | gpg --import
```
...
[download](/lucasnewcomb.ssh.pub)

```sh
curl https://nukem.dev/lucasnewcomb.ssh.pub > lucasnewcomb.ssh.pub
```
